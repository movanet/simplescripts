...
if __name__ == "__main__":
    ...
    parser.add_argument('--token_limit', type=int, help='Token limit per chunk (4000 or 8000)', required=True)

    args = parser.parse_args()

    if args.token_limit not in [4000, 8000]:
        print("Error: Token limit must be either 4000 or 8000.")
        exit(1)
